...
class ImageTestClass(TestCase):
    def setUp(self):
        ...
        self.image_test = Image(image='blotch/test.png', image_description='this is a test instance',
                                image_location=self.location, image_category=self.category)
        self.image_test.save_image()

        self.image_test1 = Image(image='blotch/test.png', image_description='this is a test instance',
                                 image_location=self.location, image_category=self.category)
